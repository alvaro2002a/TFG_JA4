...
static const uint16_t kVerifySignatureAlgorithms[] = {
    ...
    SSL_SIGN_RSA_PSS_RSAE_SHA512,    SSL_SIGN_RSA_PSS_RSAE_SHA384,
    SSL_SIGN_RSA_PSS_RSAE_SHA256,    SSL_SIGN_RSA_PKCS1_SHA512,
...
bool tls1_choose_signature_algorithm(SSL_HANDSHAKE *hs,
  ...
  if (cred->type == SSLCredentialType::kDelegated) {
    ...
    if (peer_sigalgs.empty() && version == TLS1_2_VERSION) {
      ...
      static const uint16_t kTLS12Default[] = {SSL_SIGN_ECDSA_SHA1};
